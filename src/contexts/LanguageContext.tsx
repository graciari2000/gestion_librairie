...
const translations = {
    en: {
        ...
        'home.features.vast_collection.desc': 'Access thousands of books across multiple genres and categories',
    ...
    fr: {
        ...
        'category.self_help': 'Développement Personnel',
